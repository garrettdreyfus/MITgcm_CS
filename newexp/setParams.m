...
%   diag_freq_inst = 7*t1day;
  ...
  OBNu = zeros(Nx,1)*sNorth;  
  OBNv = zeros(Nx,1)*sNorth;  
  ...
  writeDataset(OBNu,fullfile(inputpath,'OBNuFile.bin'),ieee,prec);  
  ...
  obcs_parm01.addParm('OBNuFile','OBNuFile.bin',PARM_STR);  
...
%   cvelTimeScale = 2*deltaT;
 ...
 %   
  ...
  if(useEobcsWorlanski) %%% OBCS to the east, and Orlanski to the west
      ...
      writeDataset(OBEv,fullfile(inputpath,'OBEvFile.bin'),ieee,prec);
      ...
      obcs_parm01.addParm('OBEvFile','OBEvFile.bin',PARM_STR);
  end
  ...
  if(useEobcsWobcs) %%% OBCS to the east and west
      ...
      writeDataset(OBWv,fullfile(inputpath,'OBWvFile.bin'),ieee,prec);
      ...
      obcs_parm01.addParm('OBWvFile','OBWvFile.bin',PARM_STR);
  end
