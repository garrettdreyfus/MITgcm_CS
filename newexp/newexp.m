...
%    acct = 'ddp258';
  ...
  switch(cluster)
    ...
    case 'ardbeg' 
      ...
      toolsdir = '/data2/garrett/MITgcm_CS/tools/';
      clusterdir = fullfile('/data2/garrett/MITgcm_CS/experiments/',batch_name);      
      
    case 'hoffman2'
        
      username = 'gdf';
      clustername = 'hoffman2.idre.ucla.edu';
      toolsdir = '/u/scratch/g/gdf/MITgcm_CS/tools/';
      clusterdir = ['/u/scratch/g/gdf/MITgcm_CS/',batch_name];
  ...
  buildcommands = strcat([...    
    ...
    fullfile(toolsdir,'genmake2'),' ',mpistr,'-mods=../code -of=my_opt_file -rootdir=/u/scratch/g/gdf/MITgcm/',lf, ...
    'make depend',lf, ...
