...
fname = "/data/jbod/gdf/MITgcm_CS/experiments/varysf16/imroved-warmstart-warm-sf8/results"
...
bath = np.fromfile("../experiments/varysf16/imroved-warmstart-warm-sf8/input/bathyFile.bin",">f8")
bath = bath.reshape([ds.YC.shape[0],ds.XC.shape[0]])

ds['ice'] = (('YC', 'XC'), ice)
ds['bath'] = (('YC', 'XC'), bath)

ds.to_netcdf("imroved-warmstart-warm-sf8.nc")
