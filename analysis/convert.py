...
fname = "/jbod/gdf/MITgcm_CS/experiments/width16/w250sf5/results"
...
ice = np.fromfile("../experiments/width16/w250sf5/input/SHELFICEtopoFile.bin",">f8")
ice = ice.reshape([ds.YC.shape[0],ds.XC.shape[0]])

bath = np.fromfile("../experiments/width16/w250sf5/input/bathyFile.bin",">f8")
bath = bath.reshape([ds.YC.shape[0],ds.XC.shape[0]])

ds['ice'] = (('YC', 'XC'), ice)
ds['bath'] = (('YC', 'XC'), bath)

ds.to_netcdf("w250sf5.nc")
